    ...
    {order.status === 'DECLINED' ? (
      <div className="orderConfirmation">
        <OrderConfirmationSection>
          ...
          <p>
            Para conocer los detalles del rechazo y los próximos pasos, por favor, consulta el
            estado de tu solicitud directamente en tu cuenta de Kueski o comunícate con su soporte.
          </p>
      ...
      <div className="orderConfirmation">
        <OrderConfirmationSection>
          ...
          <p>Lamentamos informarle que la transacción no pudo completarse.</p>
          <p>
            Para conocer los detalles de la cancelación y los próximos pasos, por favor, consulta el
            estado de tu solicitud directamente en tu cuenta de Kueski o comunícate con su soporte.
          </p>
          <p>Puedes intentar con otra forma de pago (de momento no disponible)</p>
          <ContinueButton siteLink={siteLink} />
